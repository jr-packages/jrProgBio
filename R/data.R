#' Malarial transmission traits and temperature
#'
#' A dataset containing measurements of malaria Sporozoite prevalence under
#' varying temperature regimes over 25 days. The experiment is split into two 
...
#'   \item{Sporozoite.Prevalence}{Value between 0 and 1, the mean for that Cup}
#' }
